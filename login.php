    ...
    if(empty($email_err) && empty($password_err)){
        ...
        if($stmt = $connection->prepare($sql)){
            ...
            if($stmt->execute()){
                ...
                // Check if  exists, if yes then verify password
                if($stmt->num_rows == 1){

                    // Bind result variables
                    $stmt->bind_result($id, $email, $verifyPassword);
...
<div class="wrapper">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
       ...
       <div class="sign-up-color"> <p>Don't have an account? <a href="register.php">Sign up now</a>.</p></div>
        <div class="sign-up-color"> <p>Want a tour <a href="homepage.php">Click Here</a> </p></div>
    </form>
</div>
